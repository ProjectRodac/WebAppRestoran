<?php
	...
	while(list($id, $naziv, $slika, $opis, $korisnik) = 
		...
		echo "<tr>
			...
			if ($aktivni_korisnik_tip==0 or 1) {
				echo "<td><a href='statistika2.php?prostorija=$id' class='link'>Statistika</a></td>";
			}
			echo "</tr>";
	}
	echo "</table>";
	...
	if ($aktivna != 1) { 
		$prethodna = $aktivna - 1;
		echo "<a class='link' href=\"stat_pice.php?stranica=" .$prethodna . "\">&lt;</a>";	
	}
